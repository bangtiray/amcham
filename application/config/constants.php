...
defined('APP_NAME') 					OR define('APP_NAME','AMCHAM CMS');
...
defined('GOOGLE_CAPTCHA_SITE_KEY') 		OR define('GOOGLE_CAPTCHA_SITE_KEY', '6LebhX0UAAAAABFuReHNjxHQxTrxYmL09gON7uMG');
defined('GOOGLE_CAPTCHA_SECRET_KEY') 	OR define('GOOGLE_CAPTCHA_SECRET_KEY', '6LebhX0UAAAAANnKpGdJsnb4A_NrWWZnx_ByvILX');
...
define('CRON_EMAIL_ADMIN', 'amar.ronaldo.m@deptechdigital.com');
// define('CRON_EMAIL_ADMIN', 'lolitajapanasik@gmail.com,amcham.or.id@gmail.com');

define('FILE_EBOOKS',	dirname(__FILE__)."/../../document/material/");

define('MIDTRANS_SERVER_KEY',	'VT-server-XddAydeJp529T9vPdBPk84N8');
define('MIDTRANS_CLIENT_KEY',	'VT-client-TyH7mlgm9D5eyrp3');
define('MIDTRANS_MERCHANT_ID',	'M092358');
