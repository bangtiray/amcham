...
class Banner extends CI_Controller {
	...
	function index(){
		...
		$data['list_banner_position'] = selectlist2(array('table'=>'banner_position','title'=>'All Position','where'=>'id = 2'));
	...
	public function add($id=''){
		...
		foreach($data['list_lang'] as $key => $value){
			...
			$data['list_lang'][$key]['list_banner_position'] = selectlist2(array('table'=>'banner_position','title'=>'All Position','selected'=>$datas[$key]['id_banner_position'],'where'=>'id = 2'));
