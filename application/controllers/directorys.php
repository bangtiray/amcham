...
class Directorys extends CI_Controller {
    ...
    function check_sector_range($type,$return){
        ...
        switch ($type) {
            case '2': // corporate
                ...
                $this->db->where_in('category_id', array('1','3'));
    ...
    function get_list_data($range,$id,$ret){
        ...
        switch ($id) {
            ...
            case '2': // company
                ...
                $this->db->where_in('a.category_id',array('1','3'));
    ...
    function uri_path_search_directory(){
        ...
        $this->db->order_by('FIELD(member_category_id, 1,4,2,3)');
        ...
        $this->db->where("(company_name_in like '%".$post['title']."%'
             or company_name_out like '%".$post['title']."%' 
        ...
        if ($counter_member_committee == 0){
            ...
            foreach ($member_commiteee as $key => $value) {
                ...
                if ($value['member_category_id'] == 1 or $value['member_category_id'] == null) { // company
                    // $img_company  = 
                    ...
                    if (imageProfile($value['company_img'],'company',1)) {
                        ...
                        $name_show   = $value['company_name_out'];
                        $img_company  = "";
                    }
                    ...
                    $name_show   = full_name_listing($value);
                }
                ...
                $ret .= '<div class="col-sm-4 col-md-4 col-xs-12"><a href="'.$link.'" ><div class="thumbnail-amcham thumb-gallery '.$alert.'">'.$name_show.'<img src="'.$img_company.'""></div></a></div>';                    
            }
        }
