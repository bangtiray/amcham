...
class GenerateRSSFeed extends CI_Controller {
	...
	function generate($key){
		if($key==KEY_GENERATE_RSS_FEED){
			...
			$data['feed_name'] 			= 'American Chamber of Commerce in Indonesia Feed RSS Feed';
			$data['feed_url'] 			= base_url().'rssfeed.xml';
			$data['page_description'] 	= 'American Chamber of Commerce in Indonesia Feed RSS Feed at '.base_url();
