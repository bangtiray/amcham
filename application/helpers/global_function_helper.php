...
function render($view,$data='',$layout="", $ret=false){
	...
	/*new script (dwiki)*/
	if(!$data['head_title']){
		$data['head_title']= 'AmCham Indonesia, American Chamber of Commerce in Indonesia since 1971';
	}
	if(!$data['meta_description']){
		$data['meta_description']= 'AmCham Indonesia, American Chamber of Commerce in Indonesia since 1971';
	}
	if(!$data['meta_keywords']){
		$data['meta_keywords']= 'AmCham';
	}

	$data['meta_og'] =($data['share']) ? meta_og($data) : '';
